...
public class DodajPitanjeTask extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... strings) {
        String url = "https://firestore.googleapis.com/v1/projects/"+ KvizoviAkt.id+"/databases/(default)/documents/Pitanja?documentId="+strings[0]+"&access_token="+KvizoviAkt.token;
        try {
            ...
            String document = "{\"fields\": {\"naziv\": {\"stringValue\": \""+strings[0]+"\"}, \"indexTacnog\": {\"integerValue\": \""+strings[1]+"\"}, \"odgovori\": {\"arrayValue\": {\"values\": [";

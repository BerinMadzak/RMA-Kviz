...
public class NabaviKvizoveTask extends AsyncTask<String, Void, Void> implements NabaviPitanjeTask.OnPitanjeSearchDone {

    private NabaviKvizoveTask.OnKvizoviSearchDone pozivatelj;
    public NabaviKvizoveTask(NabaviKvizoveTask.OnKvizoviSearchDone p) { pozivatelj = p;}
        ...
        try{
            ...
            for(int i = 0; i < docs.length(); i++) {
                ...
                for (int j = 0; j < pitanja.length(); j++) {
                    ...
                    new NabaviPitanjeTask((NabaviPitanjeTask.OnPitanjeSearchDone)this, i).execute(pjo.getString("stringValue"));
                }
